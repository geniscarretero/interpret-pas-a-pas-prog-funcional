...
\subsection{Lliurables del Projecte}
El lliurable principal d'aquest Treball de Final de Grau és la implementació completa de l'intèrpret funcional. El codi font, estructurat de forma modular i escrit íntegrament en Haskell, juntament amb la bateria de tests, és de codi obert i es troba allotjat de manera pública i accessible al següent repositori oficial: 
\url{https://github.com/geniscarretero/interpret-pas-a-pas-prog-funcional}
